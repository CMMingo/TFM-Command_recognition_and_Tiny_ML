...
# GLOBAL VARIABLES
MODEL_FILE = "./models/TL_model_quantized_ESP_MM_metadata.tflite"
DATA_ESP_PATH = "./data/esp"
LABELS_FILE = "./labels_ESP.txt"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Load random audio
        filename = random.choice(os.listdir(DATA_ESP_PATH))
        file = os.path.join(DATA_ESP_PATH, filename).replace("\\", "/")
        ...
        #interpreter = edgetpu.make_interpreter(str(MODEL_FILE))
